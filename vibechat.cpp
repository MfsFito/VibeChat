...
// MENU LOGIN
void display_menu(string nama){
    string daftar[] = {"PROFILE", "CHAT", "KONTAK", "FAVORIT", "LOGOUT"};
    int jumlah = 5;
    int option = 1;
    char key;
...
void tampilkan_chat(string nomor_tujuan){
    string daftar[] = {"PROFILE", "BALAS", "FAVORIT", "KEMBALI"};
    int jumlah = 4;
    int option = 1;
